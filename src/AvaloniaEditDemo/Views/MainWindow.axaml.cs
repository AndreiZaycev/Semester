...
namespace AvaloniaEditDemo.Views
{
    ...
    public class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            _stackPanel.Children.Add(new Button() { Height = 16.8, Margin = Thickness.Parse("0,0"), Width = 20, Background = Brush.Parse("Yellow") });
        ...
        private void _runControlBtn_Click(object sender, Avalonia.Interactivity.RoutedEventArgs e)
        {
            ...
            if (!flag)
            {
                try
                {
                    ...
                    var dictionary = Arithm.Interpreter.run(Arithm.Main.parse(text)).Item2;
